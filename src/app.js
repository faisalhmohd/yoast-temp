...
var keyphraseDistribution = new _KeyphraseDistributionAssessment2.default();
 ...
 *
 * @param {YoastSEO.App} app A reference to the YoastSEO.App to where this is called.
 */

/**
 * @callback YoastSEO.App~updateSnippetValues
 *
 * @param {Object} ev The event emitted to the DOM
 */
 ...
 * @param {Function} args.marker The marker to use to apply the list of marks retrieved to an assessment.
 *
...
/**
 * Retrieves data to the callbacks.getData and applies modification to store these in this.rawData.
 *
 * @returns {void}
 */
App.prototype.getData = function () {
	...
	if ((0, _lodashEs.isArray)(this.callbacks.custom)) {
		this.callbacks.custom.forEach(function (customCallback) {
			...
			_this.rawData = (0, _lodashEs.merge)(_this.rawData, customData);
		});
	}
...
/**
 * Inits a new pageAnalyzer with the inputs to the getInput function and calls the scoreFormatter
 * to format outputs.
 *
 * @returns {void}
 */
 ...
 * at every keystroke checks the reference object, so this function can be called to anywhere,
 ...
 *
 * The scoring object is a special object with definitions about how to translate a result to your analysis function
 * to a SEO score.
 *
