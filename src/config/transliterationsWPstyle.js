...
exports.default = function (locale) {
	if ((0, _lodashEs.isUndefined)(locale)) {
		return [];
	}

	var transliterationObjects = transliterationsGeneral;

	transliterationObjects = transliterationObjects.concat(getLanguageSpecificTransliterations((0, _getLanguage2.default)(locale)));
