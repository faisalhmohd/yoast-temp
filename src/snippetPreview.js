...
var getBaseURL = function getBaseURL() {
	...
	/*
  * For backwards compatibility, if no URL was passed to the snippet editor we try to retrieve the base URL to the
...
/**
 * Retrieves unformatted text to the data object
 *
 * @private
 * @this SnippetPreview
 *
...
/**
 * Returns the data to the Snippet Preview.
 *
...
/**
 * Formats the base url for the Snippet Preview. Removes the protocol name to the URL.
 *
...
SnippetPreview.prototype.formatCite = function () {
	...
	// Strip out question mark and hash characters to the raw URL.
	cite = cite.replace(/\?|#/g, "");
...
SnippetPreview.prototype.formatKeyword = function (textString) {
	// Removes characters to the keyword that could break the regex, or give unwanted results.
 ...
 * @param {Object} event The event to check the text length to.
 *
 * @returns {void}
 */
 ...
 *
 * When clicking on an element in the Snippet Preview, this checks and fills the textContent with the data to the
 * unformatted text. This removes the keyword highlighting and modified data so the original content can be editted.
 *
 * @param {Object} event The event to get the unformatted text to.
 *
 * @returns {void}
 */
 ...
 *
 * @param {Object} event The event to set the unformatted text to.
 *
 * @returns {void}
 */
...
SnippetPreview.prototype.bindEvents = function () {
	...
	(0, _lodashEs.forEach)(inputPreviewBindings, function (binding) {
		...
		// Make removing focus to an element, update the carets.
...
/**
 * Updates our data object to the DOM.
 *
 * @returns {void}
 */
 ...
 * cancelBubble to prevent other elements to capturing this event.
 *
 * @deprecated
 *
