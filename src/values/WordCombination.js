...
WordCombination.prototype.getMultiplier = function (relevantWordPercentage) {
  ...
  // The relevance scales linearly to the relevance of one word to the maximum.
 ...
 *
 * @param {Object} relevantWords A mapping to a word to a relevance.
 * @returns {void}
 */
...
WordCombination.parse = function (serialized) {
  var wordCombination = new WordCombination(serialized.words, serialized.occurrences, serialized.functionWords);
