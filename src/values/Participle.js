 ...
 * @param {string} sentencePart The sentence part where the participle is to.
 * @param {object} attributes The object containing all attributes.
 * @constructor
 */
...
Participle.parse = function (serialized) {
  var participle = new Participle(serialized.participle, serialized.sentencePart, serialized.attributes);
