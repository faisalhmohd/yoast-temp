...
exports.getBlocks = exports.isInlineElement = exports.isBlockElement = exports.inlineElements = exports.blockElements = undefined;
...
function createTokenizer() {
	...
	htmlBlockTokenizer = (0, _core2.default)(function (token) {
		tokens.push(token);
	});
...
function getBlocks(text) {
	...
	(0, _lodashEs.forEach)(tokens, function (token, i) {
...
var memoizedGetBlocks = (0, _lodashEs.memoize)(getBlocks);
...
exports.getBlocks = memoizedGetBlocks;
exports.default = {
