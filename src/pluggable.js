...
Pluggable.prototype._registerPlugin = function (pluginName, options) {
	...
	if (!(0, _lodashEs.isUndefined)(options) && (typeof options === "undefined" ? "undefined" : _typeof(options)) !== "object") {
 ...
 * to plugins that have declared ready within the pre-loading time in order to safeguard UX and data integrity.
 *
...
/**
 * Strips modifications to a callChain if they were not added with a valid origin.
 *
