 ...
 * @param {SEOAssessor} args.assessor The Assessor object to retrieve assessment results to.
...
/**
 * Gets the indicator color class to the presenter configuration, if it exists.
 *
...
/**
 * Get the indicator screen reader text to the presenter configuration, if it exists.
 *
 * @param {string} rating The rating to check against the config.
...
/**
 * Get the indicator screen reader readability text to the presenter configuration, if it exists.
 *
 * @param {string} rating The rating to check against the config.
...
/**
 * Get the indicator full text to the presenter configuration, if it exists.
 *
 * @param {string} rating The rating to check against the config.
...
/**
 * Excludes items to the results that are present in the exclude array.
 *
 ...
 *
 * @param {AssessmentResult} item The item to check and create a rating object to.
